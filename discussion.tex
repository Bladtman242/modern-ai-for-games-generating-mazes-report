...
In conclusion, lattice grammars turned out to be a viable solution for procedural generation of mazes. It has the flexibility of graph grammars and the spatial awareness of cellular automata, and combines the two elegantly. In the experiments it successfully generated mazes, that fit the criteria we wanted, although there is some room for improvements in terms of performance. It is in our opinion an algorithm worth considering for use in games with procedural levels of almost any kind.
