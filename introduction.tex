...
Procedurally generating levels in games that are well designed and don't break immersion is a common problem. This is especially true for roguelikes which heavily rely on procedural content to keep the player engaged \cite{6Procedu79:online, BerlinIn39:online}. The specific approach varies from game to game, and only a few algorithms are simple and generic enough to be reused across projects.
